...
class Scraper:
	...
	def request_table(self,stock_symbol):
		...
		payload = [('SymbolList',stock_symbol),('Symbol',stock_symbol),('Cart_ctl00_webPartManager_wp1629714544_wp1440203596_cbFinanceReport_Callback_Param',self.frequency),('Cart_ctl00_webPartManager_wp1629714544_wp1440203596_cbFinanceReport_Callback_Param',self.tab),('Cart_ctl00_webPartManager_wp1629714544_wp1440203596_cbFinanceReport_Callback_Param',self.unit),('Cart_ctl00_webPartManager_wp1629714544_wp1440203596_cbFinanceReport_Callback_Param',self.final_year)]
